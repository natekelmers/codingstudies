...
user_data_path = r'u.user'

# read 'u.user' into 'users'
users = pd.read_table(user_data_path, sep='|')
...
drinks_data_path = r'drinks.csv'
drinks = pd.read_csv(drinks_data_path)
...
print (list(drinks.beer_servings))
...
drinks = pd.read_csv(drinks_data_path, header=0, names=drink_cols)  # replace during file reading
...
drinks = pd.read_csv(drinks_data_path, header=0, names=drink_cols, na_filter=False)

'''
EXERCISE THREE
'''
# read ufo.csv into a DataFrame called 'ufo'
ufo_data_path = r'ufo.csv'
ufo = pd.read_csv(ufo_data_path)
...
pd.read_csv(drinks_data_path, nrows=10)           # only read first 10 rows
pd.read_csv(drinks_data_path, skiprows=[1, 2])    # skip the first two rows of data
